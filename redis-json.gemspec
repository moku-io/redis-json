require_relative 'lib/redis/json/version'

Gem::Specification.new do |spec|
  spec.name = 'redis-json'
  spec.version = Redis::JSON::VERSION
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/moku-io/redis-json'
  spec.metadata['changelog_uri'] = 'https://github.com/moku-io/redis-json/blob/master/CHANGELOG.md'
